...
static const material_id material_chitin( "acidchitin" );
static const material_id material_chitin( "chitin" );
static const material_id material_fur( "fur" );
static const material_id material_fur( "gutskin" );
...
ret_val<void> Character::can_wear( const item &it, bool with_equip_change ) const
{
    ...
    if( has_trait( trait_VEGAN ) && ( it.made_of( material_acidchitin ) || it.made_of( material_chitin ) || it.made_of( material_fur ) || it.made_of( material_gutskin ) || it.made_of( material_leather ) || it.made_of( material_wool ) ) ) {
        return ret_val<void>::make_failure( _( "Can't wear that, it's made from animals!" ) );
    }
